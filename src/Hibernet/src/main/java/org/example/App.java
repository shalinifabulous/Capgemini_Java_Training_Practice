...
import org.example.entuty.Student;
...
public class App {
    ...
    public static void main(String[] args) {
        ...
        dao.save(new Student("Shalini", "CS", 22, 85));
        dao.save(new Student("Ankita Raj", "CS", 23, 90));
        dao.save(new Student("Saumya Kumari", "IT", 23, 82));
